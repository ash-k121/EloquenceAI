            ...
            <div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start">
                  <Mail size={20} className="text-blue-500 mr-3 mt-1" />
                  <div>
                    <h3 className="font-medium text-gray-800">Email Us</h3>
                    <p className="text-gray-600">support@eloquence-ai.com</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <MessageSquare size={20} className="text-blue-500 mr-3 mt-1" />
                  <div>
                    <h3 className="font-medium text-gray-800">Live Chat</h3>
                    <p className="text-gray-600">Available 9am-5pm ET, Monday-Friday</p>
                  </div>
                </div>
              </div>
            </div>
